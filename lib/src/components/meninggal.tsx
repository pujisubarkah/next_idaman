  ...
  return (  
    <div className="p-4">  
      <div className="overflow-x-auto">  
        <h3 className="text-center text-xl font-semibold my-8">DAFTAR PEGAWAI MENINGGAL DUNIA</h3>  
        ...
        <table className="w-full border border-[#3781c7] rounded-lg overflow-hidden my-5">  
          <thead className="bg-[#3781c7]">  
            <tr className="bg-[#3781c7] text-white">  
              ...
              <th rowSpan={2} className="p-3 border border-[#f2bd1d] text-left font-bold uppercase text-sm">Keterang Meninggal</th>  
