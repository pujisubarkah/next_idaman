  ...
  <div className="flex items-center">  
    <label className="mr-4">  
      <input  
        ...
        value="Laki-laki"  
        checked={pegawai?.peg_jenis_kelamin === "Laki-laki"} // Adjusted to match the value  
        onChange={handleChange}  
        className="mr-1" // Optional: Add margin for better spacing  
      />  
      Laki-laki  
    </label>  
    <label>  
      <input  
        ...
        name="peg_jenis_kelamin"  
        value="Perempuan"  
        checked={pegawai?.peg_jenis_kelamin === "Perempuan"} // Adjusted to match the value  
        onChange={handleChange}  
        className="mr-1" // Optional: Add margin for better spacing  
      />  
      Perempuan  
