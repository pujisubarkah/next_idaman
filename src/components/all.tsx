            ...
            {paginatedUsers.length === 0 ? (  
              ...
              paginatedUsers.map(({ id, nama, username, m_status, satuan_kerja_nama, status_aktif }, index) => (  
                <tr key={id} className={index % 2 === 0 ? "bg-teal-50" : "bg-white"}>  
                  <td className="p-3 border border-[#f2bd1d] text-center">{nama}</td>  
                  <td className="p-3 border border-[#f2bd1d] text-center">{username}</td>  
                  <td className="p-3 border border-[#f2bd1d] text-center">{m_status?.role_name}</td>  
                  <td className="p-3 border border-[#f2bd1d] text-center">{satuan_kerja_nama}</td>  
                  <td className="p-3 border border-[#f2bd1d] text-center">{status_aktif === 1 ? "Aktif" : "Tidak Aktif"}</td>  
