      ...
      try {  
        ...
        if (data) {  
          setProfileData({  
            ...
            pendidikanAwal: data.nama_pend_awal || "",  
            ThnpendidikanAwal: data.peg_pend_awal_th || "",  
            pendidikanAkhir: data.pend_akhir || "",  
            ThnpendidikanAkhir: data.peg_pend_akhir_th || "",  
            jenisJabatan: data.jabatan_jenis === 2 ? "Struktural" : data.jabatan_jenis === 4 ? "Pelaksana" : "Fungsional",  
            eselon: data.eselon_id || "",  
            statusGaji: data.peg_status_gaji === 1 ? "APBN" : "Non APBN",  
