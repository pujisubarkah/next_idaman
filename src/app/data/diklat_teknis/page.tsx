...
export default function ListUnitPage() {  
  ...
  const resetForm = () => {  
    setSatuanKerjaNama("");  
    setKodeSkpd("");  
    setStatus(1); // Reset to active by default  
  ...
  const handleCreateFormSubmit = async (e: React.FormEvent) => {  
    ...
    try {  
      ...
      toggleModal(); // Close modal and refresh the data  
      fetchStatuses();  
    } catch (error) {  
  ...
  return (  
    <RootLayout>  
      <div className="flex-4 h-full px-4 overflow-auto">  
        ...
        {/* Modal for Add/Edit Diklat Teknis */}  
        {isModalOpen && (  
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">  
            <div className="bg-white p-6 rounded shadow-lg w-3/4">  
              <h2 className="text-lg font-bold mb-4">{editId ? "Edit" : "Tambah"} Diklat Teknis</h2>  
              <form onSubmit={editId ? handleFormSubmit : handleCreateFormSubmit}>  
                <div className="mb-4 flex items-center">  
                  <label className="block mb-1 w-1/3">Nama Diklat Teknis</label>  
                  <input  
                    type="text"  
                ...
                <div className="mb-4 flex items-center">  
                  ...
                  >  
                    ...
                    <option value={3}>Diklat Teknis</option>
                  </select>  
                </div>  
