            ...
            <table className="w-full border border-teal-600 rounded-lg overflow-hidden my-5">
              <thead>
                <tr className="bg-teal-900 text-white">
                  <th className="p-3 border border-teal-700 text-left font-bold uppercase text-sm">No</th>
                  <th className="p-3 border border-teal-700 text-left font-bold uppercase text-sm">Nama Jurusan</th>
                ...
                {currentUnits.length > 0 ? (
                  currentUnits.map((unit: any, index: number) => (
                    <tr key={index} className={index % 2 === 0 ? "bg-teal-50" : "bg-white"}>
                       <td className="px-4 py-2 border border-teal-300">{indexOfFirstUnit + index + 1}</td>
                      <td className="px-4 py-2 border border-teal-300">{unit.jurusan_nm}</td>
