...
const RekapJenisKelamin: React.FC = () => {
  ...
  const [pegawaiDetails, setPegawaiDetails] = useState<PegawaiDetail[]>([]);
          ...
          <table className="w-full border border-teal-600 rounded-lg">
            <thead>
              <tr className="bg-teal-900 text-white">
                <th className="p-3 border border-teal-700 text-center" rowSpan={2}>
                  No
                </th>
                <th className="p-3 border border-teal-700 text-center" rowSpan={2}>
                  Nama Satker
                </th>
                <th className="p-3 border border-teal-700 text-center" colSpan={2}>
                  Jenis Kelamin
                </th>
                <th className="p-3 border border-teal-700 text-center" rowSpan={2}>
                  Jumlah Seluruh
              ...
              <tr className="bg-teal-900 text-white">
                <th className="p-2 border border-te al-700 text-center">Laki-laki</th>
              ...
              {loading ? (
                ...
                data.map((item) => (
                  <tr key={item.no} className="bg-teal-50 hover:bg-teal-100">
                    ...
                    <td
                      className="p-3 border border-teal-300 text-center text-blue-600 cursor-pointer"
            ...
            <tfoot>
              <tr className="bg-teal-500 text-white">
                <td colSpan={2} className="p-3 border border-teal-700 text-center font-bold">
                  Total
                </td>
                <td className="p-3 border border-teal-700 text-center font-bold">
                  {totalLakiLaki}
                </td>
                <td className="p-3 border border-teal-700 text-center font-bold">
                  {totalPerempuan}
