...
import AddressForm from "./AddresForm"; // Adjust the path as necessary  
...
import PendidikanForm from "./PendidikanForm"; // Adjust the path as necessary  
import RootLayout from "../../pegawai/profile/edit/layout"; // Adjust the path as necessary  
  
interface Pegawai {  
  pegid: string; // Add pegid property
...
{pegawai && (
  <PendidikanForm 
    peg_pend_awal={pegawai.id_pend_awal} 
    peg_pend_awal_th={pegawai.peg_pend_awal_th} 
    peg_pend_akhir={pegawai.id_pend_akhir} 
    peg_pend_akhir_th={pegawai.peg_pend_akhir_th} 
    handleChange={handleChange} 
    // handleInputChangeProp={handleChange} // Remove this line
  />
)}      
 <JabatanForm />  
