  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      const [
        ...
        fetchData('m_spg_pendidikan', 'id_pend, nm_pend'),
        fetchData('m_spg_status_kepegawaian', 'id_status_kepegawaian, status'),
        fetchData('m_spg_jabatan', 'jabatan_id, jabatan_nama'),
      ...
      const combinedData = data.map(pegawai => ({
        ...
        nama_kecamatan: kecamatanMap[pegawai.id_kec] || null,
        kecamatan_ktp: kecamatanMap[pegawai.id_kec_ktp] || null,
        nama_kelurahan: kelurahanMap[pegawai.id_kel] || null,
        kelurahan_ktp: kelurahanMap[pegawai.id_kel_ktp] || null,
