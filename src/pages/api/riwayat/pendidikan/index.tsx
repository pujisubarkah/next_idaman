...
export default async function handler(req, res) {
    try {
        ...
        // Tangani error dari Supabase
        if (jurusanError) {
            console.error("Error fetching tingkat pendidikan from Supabase:", jurusanError.message);
        ...
        // Tangani error dari Supabase
        if (universitasError) {
        console.error("Error fetchinguniverstias from Supabase:", universitasError.message);
    ...
    console.log("Riwayat Pendidikan Item:", item); // Log item riwayat pendidikan
